...
final class CustomPickerViewController: UIViewController {
    ...
    private let customPickerCell = "CustomPickerCell"
    var viewTag = 0
...
extension CustomPickerViewController {
    ...
    private func configureUI() {
        ...
        let nib = UINib(nibName: customPickerCell, bundle: nil)
        pickerTableView.register(nib, forCellReuseIdentifier: customPickerCell)
    }
}
