...
final class PlusMenuViewController: UIViewController {
...
extension PlusMenuViewController {
    ...
    private func configureUI() {
        ...
        menuTableView.register(UINib.nibFromBundle(nibName: "PlusMenuCell"), forCellReuseIdentifier: "PlusMenuCell")
    }
}
