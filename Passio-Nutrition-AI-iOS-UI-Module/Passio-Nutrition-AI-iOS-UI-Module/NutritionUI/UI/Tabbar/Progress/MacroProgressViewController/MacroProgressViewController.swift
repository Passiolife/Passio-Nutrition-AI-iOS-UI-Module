...
class MacroProgressViewController: UIViewController{
    ...
    func setupUI() {
        segmentControl.defaultConfiguration(font: UIFont.custom(.regular, 14), color: .gray700)
        segmentControl.selectedConfiguration(font: UIFont.custom(.regular, 14), color: .white)
