...
extension DiaryViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if sections[indexPath.section].0 == .dailyNutrition {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DailyNutritionWithDateCollectionViewCell", for: indexPath) as! DailyNutritionWithDateCollectionViewCell
