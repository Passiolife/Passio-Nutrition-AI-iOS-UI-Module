...
final class EditProfileViewController: UIViewController {
    ...
    private let hemburgarMenuOptions : [HemburgarMenuOptions] = [.tutorials,.settings,.logout]
    ...
    func hemburgerOptionSelected(index: Int) {
        ...
        case .logout:
            self.logout()
        case .settings:
            let settingsVC = NutriationUICoordinator.getEditSettingsViewController()
...
extension EditProfileViewController {
    ...
    private func configureUI() {
        ...
        CellsProfile.allCases.forEach {
            let cell = UINib(nibName: $0.rawValue, bundle: nil)
            profileTableView.register(cell, forCellReuseIdentifier: $0.rawValue)
        }
    }
...
extension EditProfileViewController {
    ...
    @objc private func showHeightPickerView() {
        view.endEditing(true)
        let editSB = UIStoryboard(name: "EditProfile", bundle: nil)
        let pickerView = editSB.instantiateViewController(withIdentifier: "CommonPickerViewController") as! CommonPickerViewController
    ...
    @objc private func showGendterPickerView(_ sender: UIButton){
    ...
    @objc private func showMacroNutrientPickerView() {
        view.endEditing(true)
        let editSB = UIStoryboard(name: "EditProfile", bundle: nil)
        let pickerView = editSB.instantiateViewController(withIdentifier: "PickerMacrosViewController") as! PickerMacrosViewController
...
extension EditProfileViewController: UITableViewDataSource,UITableViewDelegate {
    ...
    private func getUserPreferencesCell(indexpath: IndexPath, profile: UserProfileModel?) -> UITableViewCell {
        ...
        cell.genderButton.addTarget(self, action: #selector(showGendterPickerView), for: .touchUpInside)
