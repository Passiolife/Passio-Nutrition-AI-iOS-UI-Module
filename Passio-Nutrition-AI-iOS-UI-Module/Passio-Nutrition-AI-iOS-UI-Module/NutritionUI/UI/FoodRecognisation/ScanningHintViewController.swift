...
class ScanningHintViewController: UIViewController{
    ...
    class func presentHint(presentigVC: UIViewController?, didDismissed: (() -> Void)?){
        let foodRecoSB = UIStoryboard(name: "FoodRecognisation", bundle: nil)
        let hintVC = foodRecoSB.instantiateViewController(withIdentifier: "ScanningHintViewController") as! ScanningHintViewController
